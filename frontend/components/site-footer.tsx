...
const footerLinks = [
  ...
  },
  {
    heading: "Сценарии",
    links: [
      { label: "Владельцам сайтов", href: "/#use-case-site-owners" },
      { label: "Юристам", href: "/#use-case-lawyers" },
      { label: "Маркетингу и продукту", href: "/#use-case-marketing" },
      { label: "Командам безопасности", href: "/#use-case-security" },
    ],
  },
  {
    heading: "Ресурсы",
  ...
  return (
    <footer className="relative w-full overflow-hidden border-t border-white/10 bg-background/90">
      <div className="relative z-10 mx-auto grid max-w-7xl gap-10 px-5 py-14 sm:px-8 md:grid-cols-[1.2fr_2fr] lg:px-10 lg:py-16">
        <div>
          ...
          <p className="mt-4 max-w-sm text-sm leading-6 text-muted-foreground">
            Легальный технический инструмент для первичной проверки сайтов на
      ...
      <div className="pointer-events-none relative z-0 overflow-hidden px-0 pt-2">
        <p className="footer-project-word select-none text-center">{appName}</p>
      </div>
    </footer>
  );
}
