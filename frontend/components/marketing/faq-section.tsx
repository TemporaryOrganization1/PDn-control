...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Да, гость и free-аккаунт получают 3 проверки за скользящие 30 дней. Доступный лимит показывается рядом с формой.",
  },
  {
    question: "Что я получу после проверки?",
    answer:
      "Free получает статусы и краткие выводы. Paid дополнительно получает URLs, технические evidence, скриншоты и PDF.",
  },
  {
