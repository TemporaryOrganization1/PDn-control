...
const points = [
  ...
  },
  {
    icon: LockKeyhole,
    title: "PDF и история",
    text: "Отчеты можно использовать как артефакт для внутреннего контроля и обсуждения.",
  },
  {
    icon: RefreshCw,
    title: "Повторяемый сценарий",
    text: "Один и тот же UX подходит для первичной проверки, повторного контроля и подготовки к аудиту.",
  },
];
